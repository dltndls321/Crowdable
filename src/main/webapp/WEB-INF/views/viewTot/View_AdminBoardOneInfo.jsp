...
<div class="w3-card login_regist_table w3-center" style="margin-top: 2%; margin-bottom: 15%;">
	<form  method="post">
		<table class="w3-table w3-center">
			...
			<c:if test="${!empty boardoneview.enddate }">
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
			<td colspan="1" style="color: #888888">프로젝트종료일</td>
				<td colspan="3" class="w3-left" style="color: #000000" >
					<fmt:formatDate value="${boardoneview.enddate}" pattern="yyyy-MM-dd"/>
				 </td>
			</tr>
			</c:if>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
			...
			<c:if test="${!empty boardoneview.wantmoney }">
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">희망금액</td>
				<td colspan="3" class="w3-left" style="color: #000000" >
					<c:out value="${boardoneview.wantmoney}" escapeXml="false"/>
				 </td>
			</tr>
			</c:if>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
			...
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">첫번쨰 선물</td>
				<td colspan="3" class="w3-left" style="color: #000000" >
					<c:out value="${giftinfo.giftcontentone}" escapeXml="false"/>
				 </td>
			</tr>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">첫번쨰 희망금액</td>
				<td colspan="3" class="w3-left" style="color: #000000" >
					<c:out value="${giftinfo.giftmoneyone}" escapeXml="false"/>
				 </td>
			</tr>
			</c:if>
			<c:if test="${!empty giftinfo.giftcontenttwo}">
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">두번쨰 선물</td>
				<td colspan="3" class="w3-left" style="color: #000000" >
					<c:out value="${giftinfo.giftcontenttwo}" escapeXml="false"/>
				 </td>
			</tr>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">두번쨰 희망금액</td>
				<td colspan="3" class="w3-left" style="color: #000000" >
					<c:out value="${giftinfo.giftmoneytwo}" escapeXml="false"/>
				 </td>
			</tr>
			</c:if>
			<c:if test="${!empty giftinfo.giftcontentthree }">
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">세번쨰 선물</td>
				<td colspan="3" class="w3-left" style="color: #000000" >
					<c:out value="${giftinfo.giftcontentthree}" escapeXml="false"/>
				 </td>
			</tr>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">세번쨰 희망금액</td>
				<td colspan="3" class="w3-left" style="color: #000000" >
					<c:out value="${giftinfo.giftmoneythree}" escapeXml="false"/>
				 </td>
			</tr>
			</c:if>
			<tr >
				<c:if test="${boardoneview.activestatus eq '1'}">
					<td colspan="2" ><button id="Admin_boardupdate_submit1" type="button">게시글 수정 요청</button></td>
				</c:if>
				<c:if test="${boardoneview.activestatus eq '4'}">
					<td colspan="2" ><button id="Admin_boardupdate_submit2" type="button">게시글 활성화</button></td>
				</c:if>

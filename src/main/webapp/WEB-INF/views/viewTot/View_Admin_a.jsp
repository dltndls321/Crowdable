	...
	<form  method="post">
		<table class="w3-table w3-center">
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">이름</td><td colspan="3" class="w3-left" style="color: #888888"><input id="Admin_a_name" type="text" value="${Admin_Items.name}"></td>
			</tr>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">지역</td><td colspan="3" class="w3-left" style="color: #888888"><input id="Admin_a_address" type="text" value="${Admin_Items.address}"></td>
			</tr>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">소개</td><td colspan="3" class="w3-left" style="color: #888888"><textarea id="Admin_a_content">${Admin_Items.content}</textarea ></td>
			</tr>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">전화번호</td><td colspan="3" class="w3-left" style="color: #888888"><input id="Admin_a_phone" type="text" value="${Admin_Items.phone}"></td>
			</tr>
			<tr style="border-top: 1px;border-bottom: 1px; border-color: #888888;">
				<td colspan="1" style="color: #888888">비밀번호</td><td colspan="3" class="w3-left" style="color: #888888"><input id="Admin_a_passwd" type="text" value="${Admin_Items.passwd}"></td>
			</tr>
